...
# --- BANCO DE QUESTÕES: OPERAÇÃO PRF (50 QUESTÕES) ---
questoes = [
...
def index():
    # Sorteia 5 questões aleatórias do banco de 50
    if len(questoes) >= 5:
...
# Rota de IA (Desativada para garantir estabilidade)
@app.route('/explicar_ia', methods=['POST'])
def explicar_ia():
    return jsonify({"explicacao": "Funcionalidade em manutenção. Utilize o gabarito oficial."})
